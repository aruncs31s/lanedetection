...
class DetectionSystem:
    ...
    def create_dashboard(self, main_frame, mask_frame, edges_frame):
        ...
        # Add labels
        cv2.putText(dashboard, "Main View", (10, 20), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
        cv2.putText(dashboard, "Object Mask", (width + 10, 20), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
        cv2.putText(dashboard, "Lane Detection", (width + 10, small_height + 20), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
    ...
    def detect_objects(self, frame):
        ...
        for contour in contours:
            ...
            if area > self.min_area:
                ...
                cv2.putText(frame, f'Dist: {height - bottom_y}px', (x, y - 10),
                           cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)
                cv2.putText(frame, f'Area: {area:.0f}', (x, y - 25),
                           cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)
        
        # Add status overlay
        status = "OBSTACLE DETECTED" if obstacle_detected else "NO OBSTACLE"
        cv2.putText(frame, status, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 
                   1, (0, 0, 255) if obstacle_detected else (0, 255, 0), 2)
    ...
    def process_lane_detection(self, frame):
        ...
        cv2.putText(combined, f"Curve: {smooth_curve:.2f}", (10, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
